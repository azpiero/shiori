...
test('immediate exits and failed starts do not leave a busy panel',async()=>{
...
test('information popover shows full live paths, dismisses accessibly and omits shell controls',async()=>{
 ...
 assert.equal(s.get('#terminalStop'),null);
